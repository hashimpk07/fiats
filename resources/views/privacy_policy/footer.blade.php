...
<div class="light-wrapper" style="background-color:#fff;">
    <div class="container inner">
        <div class="row story">
            <div  class="text-center">
                <div class="col-xs-12">
                    
                    <div class="col-xs-12"><span class="home-heading">www.fiatscriptura.org Privacy Policy</span></div>
            ...
            <div class="col-sm-12">
                <div class="col-wrapper" style="text-align:justify;">
                   ...
                   <p>This privacy policy has been compiled to better serve those who are concerned with how their 'Personally Identifiable Information' (PII) is being used online. PII, as described in US privacy law and information security, is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context. Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your Personally Identifiable Information in accordance with our website.</p>
                    ...
                    <p class="strong">How do we use your information?</p>
                    <p>We may use the information we collect from you when you register, make a purchase, sign up for our newsletter, respond to a survey or marketing communication, surf the website, or use certain other site features in the following ways</p>
                    <p class="strong">How do we protect your information?</p>
                    <p class="strong">Do we use 'cookies'?</p>
                    ...
                    <p class="strong">Third-party disclosure</p>
                    <p class="strong">Third-party links</p>
                    <p class="strong">Google</p>
                    ...
                    <p class="strong">We have implemented the following:</p>
                    <p>We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie) or other third-party identifiers together to compile data regarding user interactions with ad impressions and other ad service functions as they relate to our website.</p>
                    <p>

                    <p class="strong">Opting out:</p>
                        Users can set preferences for how Google advertises to you using the Google Ad Settings page. Alternatively, you can opt out by visiting the Network Advertising Initiative Opt Out page or by using the Google Analytics Opt Out Browser add on.

                        <p  class="strong">California Online Privacy Protection Act</p>
                        ...
                        <p  class="strong">How does our site handle Do Not Track signals?</p>
                        ...
                        <p  class="strong">To be in accordance with CANSPAM, we agree to the following:</p>
...
<br/><br/>
                        <p  class="strong">Contacting Us</p>
                        If there are any questions regarding this privacy policy, you may contact us using the information below.<br/>
                        www.fiatscriptura.org<br/>
                        Fiat Scriptura, TC 7/501,St. Antonys Street,Kuriachira,<br/>
                        Thrissur -, KERALA 680006<br/>
                        India<br/>
                        fiatscriptura@gmail.com<br/>
                        0487 3263930<br/>
